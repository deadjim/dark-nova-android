...
public class xenongame extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     //   getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.title);
        	...
        	t1.setText("At 19 clicks from Xenon you");
            ...
            bignore.setOnClickListener(new OnClickListener() {
            	public void onClick(View v){
                	...
                	t1.setText("At 16 clicks from xenon you");
            		...
            		{
            			t1=(TextView) findViewById(R.id.line1);
                    	t1.setText("At 14 clicks from Xenon you");
                    	t2=(TextView) findViewById(R.id.line2);
                    	t2.setText("encounter a police T'khar uberhauler");
                    	t3=(TextView) findViewById(R.id.line3);
                    	t3.setText("The police hail they want you to");
                    	t4=(TextView) findViewById(R.id.line4);
                    	t4.setText("surrender");
            		...
            		{
            			t1=(TextView)findViewById(R.id.line1);
                    	t1.setText("At 11 clicks from Xenon you");
                    	t2=(TextView)findViewById(R.id.line2);
                    	t2.setText("encounter a police Spathi scout");
                    	t3=(TextView) findViewById(R.id.line3);
                    	t3.setText("You police hail theywant you to");
                        t4=(TextView) findViewById(R.id.line4);
                    	t4.setText("surrender");
                    	ignore = 3;
            		...
            		{
            			t1=(TextView)findViewById(R.id.line1);
                    	t1.setText("At 6 clicks from Xenon you");
                    	t2=(TextView)findViewById(R.id.line2);
            		...
            		{
            			t1=(TextView)findViewById(R.id.line1);
                    	t1.setText("At 3 clicks from Xenon you.");
                    	t2=(TextView)findViewById(R.id.line2);
                    	t2.setText("encounter a police Vorlon Cruiser");
                    	t3=(TextView) findViewById(R.id.line3);
