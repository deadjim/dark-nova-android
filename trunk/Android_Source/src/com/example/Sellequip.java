...
public class Sellequip extends Activity implements OnClickListener  {
	...
	private Button sellequipmentclose,sell1,sell2,sell3,sell4,sell5,sell6,sell7,sell8,sell9;
	private TextView sellcash;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        sellequipmentclose=(Button)this.findViewById(R.id.ButtonTitleCLose);
        ...
        sellcash=(TextView) this.findViewById(R.id.CashbuyeTextView);
        sellcash.setText(String.valueOf(Globala.credits));
    	...
    	t3.setVisibility(View.INVISIBLE);
		 if(Globala.getSellEquipmentPrice(0) > 0.0 && Globala.countsellequip1==0)
	     {
	 		 ...
	 		 t2.setText(String.valueOf(Globala.getSellEquipmentPrice(0)));
	     ...
	     if(Globala.getSellEquipmentPrice(1) > 0.0 && Globala.countsellequip2==0)
	     {
	 		 ...
	 		 t2.setText(String.valueOf(Globala.getSellEquipmentPrice(1)));
	 		 t2.setVisibility(View.VISIBLE);
	     }
	 	else
	 	{
    		...
    		if(Globala.getSellEquipmentPrice(2) > 0.0 && Globala.countsellequip3==0)
            {
            	 ...
            	 t2.setVisibility(View.VISIBLE);
        		 t2.setText(String.valueOf(Globala.getSellEquipmentPrice(2)));
    		...
    		if(Globala.getSellEquipmentPrice(3) > 0.0 && Globala.countsellequip4==0)
            {
            	 ...
            	 t2.setVisibility(View.VISIBLE);
        		 t2.setText(String.valueOf(Globala.getSellEquipmentPrice(3)));
    		...
    		if(Globala.getSellEquipmentPrice(4) > 0.0 && Globala.countsellequip5==0)
            {
            	 ...
            	 t2.setVisibility(View.VISIBLE);
        		 t2.setText(String.valueOf(Globala.getSellEquipmentPrice(4)));
    		...
    		else
    		{
    		 ...
    		 sell5=(Button) this.findViewById(R.id.ButtonSellReflection);
       	     sell5.setVisibility(View.INVISIBLE);
       	     t1=(TextView)this.findViewById(R.id.ReflectionSellTextView05);
       	     t1.setVisibility(View.INVISIBLE);
           	 t2=(TextView) this.findViewById(R.id.ReflectionSellTextView15);
       		 t2.setVisibility(View.INVISIBLE);
    		}
    		if(Globala.getSellEquipmentPrice(5) > 0.0 && Globala.countsellequip6==0)
            {
            	 ...
            	 t2.setVisibility(View.VISIBLE);
        		 t2.setText(String.valueOf(Globala.getSellEquipmentPrice(5)));
    		...
    		if(Globala.getSellEquipmentPrice(6) > 0.0 && Globala.countsellequip7==0 )
            {
            	 ...
            	 t2.setVisibility(View.VISIBLE);
        		 t2.setText(String.valueOf(Globala.getSellEquipmentPrice(6)));
        	//	t3 = (TextView)this.findViewById(R.id.TextViewNoGadegts);
        	//	t3.setVisibility(View.INVISIBLE);
            }
    		else
    		...
    		if(Globala.getSellEquipmentPrice(7) > 0.0 && Globala.countsellequip8==0 )
            {
            	 ...
            	 t2.setVisibility(View.VISIBLE);
        		 t2.setText(String.valueOf(Globala.getSellEquipmentPrice(7)));
    		...
    		if(Globala.getSellEquipmentPrice(8) > 0.0 && Globala.countsellequip9==0)
            {
            	 ...
            	 t2.setVisibility(View.VISIBLE);
        		 t2.setText(String.valueOf(Globala.getSellEquipmentPrice(8)));
    	 ...
    	 if(v==this.sell1)
    	 {
				...
				confirm.setOnClickListener(new OnClickListener() 
				{
					...
					{	
						 ...
						 Globala.sellEquipment(0);
						 sellcash=(TextView) findViewById(R.id.CashbuyeTextView);
					     sellcash.setText(String.valueOf(Globala.credits));
						 alertDialog1.cancel();
    	 ...
    	 if(v==this.sell5)
    	 {
				...
				confirm.setOnClickListener(new OnClickListener() 
				{
					...
					{	
						...
						Globala.sellEquipment(4);
						sellcash=(TextView) findViewById(R.id.CashbuyeTextView);
					     sellcash.setText(String.valueOf(Globala.credits));
						
						Globala.countsellequip5=1;
