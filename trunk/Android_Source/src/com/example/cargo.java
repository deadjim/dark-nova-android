...
public class cargo extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bquests3=(Button)this.findViewById(R.id.quests03);
        ...
        bshipinfo3.setOnClickListener(new OnClickListener() {
        	public void onClick(View v){
        		Intent shipinfo1=new Intent(cargo.this,ShipInfo.class);
        ...
        String vv=Globala.drawSpecialCargoForm();
        TextView t=(TextView)this.findViewById(R.id.specialcargoText);
        t.setText(vv);
